"""
    ...
    추가: 범주화해서 CrossEntropyLoss 쓸거임

    Counter({0: 8360, 1: 5111, 2: 1803})
    Counter({0: 13716, 1: 978, 2: 566, 3: 14})
    Counter({0: 830, 1: 6212, 2: 8232})
    Counter({0: 4724, 1: 5223, 2: 3638, 3: 1314, 4: 375})
...
import numpy as np
import pandas as pd
from import_data import DATA_PREPROCESS, DATA_PREPROCESS_SH, NORMALIZATION, CATEGORIZATION
import torch
